...
typedef struct {
	...
	tipo_pala pala;
	tipo_pelota pelota;
	tmr_t* tmr_actualizacion_juego; // Meter el puntero del tmr dentro del sistema para que Todo tenga acceso a el
	////MEJORA 6
	int vidas;
} tipo_arkanoPi;

int timeoutCool; //MEJORA 5

tipo_pantalla pantalla_aux;
//------------------------------------------------------------------------
